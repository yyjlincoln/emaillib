...
class NowaskmeGeneralEmail(EmailTemplate):
    ...
    def _GenerateEmail(self, **keywords) -> str:
        ...
        if 'sendername' not in keywords:
            keywords['sendername'] = 'Lincoln\nDeveloper of nowask.me'
...
class NowaskmeLoginVerification(EmailTemplate):
